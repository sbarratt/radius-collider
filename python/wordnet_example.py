...
while 1:
	...
	item1_ss = get_synset(item1)
	item2_ss = get_synset(item2)
	...
	print "Resnik Brown:", item1_ss.res_similarity(item2_ss, brown_ic) 						#14.0 us
	print "Resnik Semcor:", item1_ss.res_similarity(item2_ss, semcor_ic) 					#14.1 us
	print "Jiang-Conrath Brown:", item1_ss.jcn_similarity(item2_ss, brown_ic) 		#14.9 us
	print "Jiang-Conrath Genesis:", item1_ss.jcn_similarity(item2_ss, genesis_ic) #14.9 us
	print "Lin semcor:", item1_ss.lin_similarity(item2_ss, semcor_ic) 						#14.7 us
